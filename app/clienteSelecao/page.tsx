  ...
  const cards = [
    {
      ...
      image: getAssetPath("/images/contratosAntigos.jpg"),
    ...
    },
    {
      ...
      image: getAssetPath("/images/novosContratos.jpg"),
      buttonText: "Enviar Documentos",
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col flex-1 p-5">
          <div className="font-semibold text-base mb-1 text-primary text-center">
            {card.title}
          </div>
          <p className="text-textColor text-xs leading-relaxed text-center">
            {card.description}
          </p>
        </div>
      </div>
